...
object KavvoroI18n {
    ...
    fun t(language: KavvoroLanguage, english: String): String {
        ...
        return phrases[english]?.get(language) ?: english
    }
    ...
    private val copyOverrides = mapOf(
        ...
        copyRow("CONTINUE FREE", "Free Continue", "Continuă gratuit"),
        ...
        copyRow("Brainball rebooting. Try a shorter hold.", "Brainball rebooting. Try a shorter hold.", "Brainball se resetează. Încearcă un hold mai scurt."),
        copyRow("Brainball rebooting. Try cleaner taps.", "Brainball rebooting. Try cleaner taps.", "Brainball se resetează. Încearcă atingeri mai curate."),
    ...
    private val phrases = mapOf(
        ...
        row("FIRST RUN", "Prima tură", "Primera partida", "Première run", "Erster Run", "Prima run", "Primeira run", "Eerste run", "Pierwszy run", "İlk koşu", "Первый забег", "Перший забіг", "أول جولة", "पहला रन", "Run pertama", "Lượt đầu", "初回ラン", "첫 런", "首次挑战"),
        row("START LEVEL 01", "Start nivel 01", "Inicio nivel 01", "Départ niveau 01", "Start Level 01", "Avvia livello 01", "Iniciar nível 01", "Start level 01", "Start poziom 01", "Seviye 01 başlat", "Старт уровень 01", "Старт рівень 01", "ابدأ المستوى 01", "लेवल 01 शुरू", "Mulai level 01", "Bắt đầu cấp 01", "レベル01開始", "레벨 01 시작", "开始关卡 01"),
        ...
        row("ALL FREE REWARDS UNLOCKED", "Toate recompensele gratuite sunt deblocate", "Todas las recompensas gratis desbloqueadas", "Toutes les récompenses gratuites sont débloquées", "Alle Gratis-Belohnungen freigeschaltet", "Tutte le ricompense gratis sbloccate", "Todas as recompensas grátis desbloqueadas"),
        ...
        row("RUN COMPLETE", "Run complet", "Run completada", "Run terminée", "Run abgeschlossen", "Run completata", "Run completa"),
        row("RUN INTERRUPTED", "Run întrerupt", "Run interrumpida", "Run interrompue", "Run unterbrochen", "Run interrotta", "Run interrompida"),
        row("RIFT COLLAPSED", "Rift prăbușit", "Rift colapsado", "Rift effondré", "Rift kollabiert", "Rift collassato", "Rift colapsado"),
        ...
        row("REWARD SIGNAL", "Semnal recompensă", "Señal recompensa", "Signal récompense", "Belohnungs-Signal", "Segnale ricompensa", "Sinal recompensa"),
        ...
        row("CONTINUE FREE", "Continuă gratis", "Continuar gratis", "Continuer gratuit", "Gratis weiter", "Continua gratis", "Continuar grátis"),
        ...
        row("RIFT ONLINE", "Rift online", "Rift online", "Rift en ligne", "Rift online", "Rift online", "Rift online"),
        ...
        row("RIFT ENERGY RESETS / LEVEL RESTARTS", "Energia Rift se resetează / nivelul reîncepe", "Energía Rift reinicia / nivel reinicia", "Énergie Rift remise à zéro / niveau relancé", "Rift-Energie reset / Level startet neu", "Energia Rift reset / livello riavvia", "Energia Rift reinicia / nível reinicia"),
        row("Keep streak %s with one ad.", "Păstrezi streak %s cu o reclamă.", "Mantén racha %s con un anuncio.", "Garde la série %s avec une pub.", "Serie %s mit einer Ad halten.", "Mantieni serie %s con un annuncio.", "Mantém série %s com um anúncio."),
        row("Free recovery available. Streak %s stays active.", "Recovery gratis disponibil. Streak %s rămâne activ.", "Recuperación gratis disponible. Racha %s sigue activa.", "Récupération gratuite. Série %s reste active.", "Gratis-Rettung verfügbar. Serie %s bleibt aktiv.", "Recupero gratis disponibile. Serie %s resta attiva.", "Recuperação grátis disponível. Série %s continua ativa."),
        ...
        row("AGE CHECK", "Verificare vârstă", "Control de edad", "Vérification âge", "Alterscheck", "Controllo età", "Verificação de idade"),
        row("Enter your age in years.", "Introdu vârsta în ani.", "Introduce tu edad en años.", "Entre ton âge en années.", "Gib dein Alter in Jahren ein.", "Inserisci l'età in anni.", "Insere a tua idade em anos."),
        row("CONTINUE", "Continuă", "Continuar", "Continuer", "Weiter", "Continua", "Continuar", "Doorgaan", "Kontynuuj", "Devam", "Продолжить", "Продовжити", "متابعة", "जारी रखें", "Lanjut", "Tiếp tục", "続ける", "계속", "继续"),
        row("Only the age group is saved locally.", "Se salvează local doar grupa de vârstă.", "Solo se guarda localmente el grupo de edad.", "Seul le groupe d'âge est stocké localement.", "Nur die Altersgruppe wird lokal gespeichert.", "Si salva solo il gruppo età.", "Só o grupo etário é guardado localmente."),
