...
class LegalDocumentActivity : ComponentActivity() {
    ...
    private fun aboutHtml(): String = """
        ...
        *{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font:16px/1.6 Arial,sans-serif;padding:26px 18px 44px}main{max-width:720px;margin:0 auto}
        ...
        .card{position:relative;margin:14px 0;padding:20px;border:1px solid var(--line);border-radius:16px;background:linear-gradient(145deg,var(--panel2),var(--panel));overflow:hidden}.card.current{border-color:#247984}.card.current:before{content:'';position:absolute;inset:0 auto 0 0;width:4px;background:var(--green)}.card.future{border-color:#4b3c27}.card.future:before{content:'';position:absolute;inset:0 auto 0 0;width:4px;background:var(--gold)}.status{margin-bottom:8px;color:var(--muted);font-size:11px;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.current .status{color:var(--green)}.future .status{color:var(--gold)}.card p{color:var(--muted);margin:9px 0 14px}.tags{display:flex;flex-wrap:wrap;gap:7px}.tag{border-color:#315b65;color:#bfeef1;font-size:10px}.button{display:inline-block;margin-top:4px;padding:10px 14px;border:1px solid var(--cyan);border-radius:9px;background:#102630;color:var(--text);font-weight:700;text-decoration:none}.button.disabled{border-color:#4b402d;background:#1a1a18;color:#a7997c}.contact{color:var(--cyan);font-weight:700}.note{margin-top:12px;color:#8f9baa;font-size:13px}
        ...
        <section><h2>In development</h2><p class='section-intro'>New MoonSol Studios experiences are being prepared for the next release cycle. Store actions stay disabled until a listing is public.</p>
          <article class='card future'><div class='status'>In development</div><h3>Kavvoro Rift Lab</h3><p>The next game in the Kavvoro universe, with a different rhythm and new ways to interact with the Rift. Details will be announced when the game is ready.</p><span class='button disabled'>Coming soon to Google Play</span></article>
          <article class='card future'><div class='status'>Title to be announced</div><h3>More MoonSol Studios games</h3><p>Additional original projects are in development. Each title will receive its own store page and announcement when it is ready.</p><span class='button disabled'>Coming soon to Google Play</span><p class='note'>No download action is shown for unreleased projects.</p></article>
        </section>
