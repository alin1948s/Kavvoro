...
object LocalizationCatalog {
    ...
    val allowlistedEnglishValues: Set<String> = setOf(
        "Kavvoro", "Brainball", "Rift", "HYPE", "Classic", "Chaos",
        "Google Play", "Firebase", "AdMob"
    )
        ...
        return synchronized(localeCache) {
            localeCache.getOrPut(resolvedLanguage) {
                ...
                requiredKeys.associateWith { key ->
                    overlay[key] ?: KavvoroI18n.sourceTranslation(resolvedLanguage, key) ?: key
                }
            }
        }
    }
    ...
    internal val sourceInventory: Set<String> =
        (KavvoroI18n.sourceKeyInventory + TutorialCopy.requiredKeys).toSortedSet()
}
